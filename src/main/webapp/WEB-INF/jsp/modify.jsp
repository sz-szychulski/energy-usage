    ...
    <form method="post" action="/modified/${id}">
        <table>
            ...
            <tr>
                ...
                <td><input type="number" name="energy_consumption" min="1" value="${energy_consumption}" required/></td>
            </tr>
            <tr>
                <td style="font-weight: bold">Time usage [minutes/day]</td>
                <td><input type="number" name="time" min="1" value="${time}" required/></td>
            </tr>
            <tr>
                <td colspan="2"><input type="submit" value="Modify Device" /></td>
            </tr>
        </table>
    </form>
    <script>
